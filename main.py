...
STRATEGY_FILE = "/storage/emulated/0/MY MEDIA/My Scripts/Final Combo Scripts/Casino Tools Pro v4/strategies_master.json"
TRACKER_FILE = "/storage/emulated/0/MY MEDIA/My Scripts/Final Combo Scripts/Casino Tools Pro v4/tracker_state.json"
...
class SportsLabScreen(Screen):
    def __init__(self, **kw):
        ...
        for name, sid in tools:
            ...
            btn.color = (1, 1, 1, 1)
            btn.bind(on_release=lambda x, s=sid: setattr(self.manager, 'current', s))
